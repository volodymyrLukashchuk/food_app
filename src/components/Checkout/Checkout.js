    ...
    return (
      <div key={time.id}>
        <div
          ...
          className={
            selectedTime?.id === time.id ? "mid-boxz actives" : "mid-box"
          }
        >
          <p>{time.title}</p>
    ...
    return (
      <div key={num.id}>
        <div
          ...
          className={
            selectedNumber?.id === num.id ? "mid-boxes actives" : "mid-box"
          }
        >
          <div className="num-icons-div">
            <p>{num.title}</p>
            <div className="address-icons">
              <img onClick={() => deleteNumber(num.id)} src={closeSVG} alt="" />
            </div>
          </div>
          <span>{num.num}</span>
        </div>
      ...
      <div className="left">
        <div className="address">
          ...
          <div className="address-bottom">
            {allAddresses.map((add) => renderAddress(add))}
          </div>
        </div>
        <div className="address schedule">
          ...
          <div className="delivery-mid">
            {timeMid.map((time) => renderUpperTime(time))}
          </div>
          <div className="delivery-bottom">
            {timeBot.map((time) => renderLowerTime(time))}
          </div>
        </div>
        ...
        <div className="address number">
          ...
          <div className="contact-bottom">
            {allNumbers.map((num) => renderNumber(num))}
          </div>
        </div>
    ...
    <div className="checkout">
      <div className="checkout-form">
        <div className="delivery-info">
          {renderUpperCheckoutPage()} {renderLowerCheckoutPage()}
        </div>
      </div>
    </div>
  );
